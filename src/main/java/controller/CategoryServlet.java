...
/**
 * Servlet template for Category entity.
 */
...
public class CategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter writer = response.getWriter()) {
            ...
            writer.println("<title>CategoryServlet</title>");
            writer.println("</head>");
            ...
            writer.println("<h2 class='card-title'>Привет CategoryServlet</h2>");
            writer.println("<p class='card-text'>Шаблон сервлета для работы с категориями продуктов.</p>");
